...
<head>
  ...
  <title>Perhitungan PSI - MTS NUR IMAN MLANGI</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="../perhitungan/perhitungan_psi.php">
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Perhitungan PSI</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item">Home</li>
          <li class="breadcrumb-item">Perhitungan PSI</li>
          <li class="breadcrumb-item active">Data Perhitungan PSI</li>
        </ol>
      </nav>
    </div>
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        // Ambil data nilai sebelum normalisasi
        ...
        <div class="card">
          <div class="card-body">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <?php
                // Hitung nilai rata-rata kinerja yang dinormalisasi
        ...
        <div class="card">
          <div class="card-body">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <?php
                // Deklarasi array untuk menyimpan total nilai
                $totalNilai = array_fill_keys($uniqueKriteria, 0);

                // Tampilkan nilai kriteria dikurangi dengan nilai rata-rata kinerja
                foreach ($alternatif as $siswa) {
                  echo "<tr>";
                  echo "<td>" . $siswa['kode_siswa'] . "</td>";

                  // Ambil nilai bobot subkriteria dan normalisasikan
                  foreach ($nama_kriteria as $kriteria) {
                    ...
                    // Kurangi nilai normalisasi dengan rata-rata kinerja
                    $rataRata = $totalNormalisasi[$kodeKriteria] / count($nama_kriteria);
                    $nilaiKurangRataRata = $normalisasi - $rataRata;

                    // Tambahkan nilai ke total nilai untuk kriteria tersebut
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
                  <td>Deviasi</td>
                  <?php
                  $totalSemuaDeviasi = 0; // Inisialisasi total deviasi
                  foreach ($uniqueKriteria as $kriteria) {
                    // Hitung nilai deviasi untuk kriteria ini
                    $deviasi = 1 - $totalNilai[$kriteria];
                    $totalSemuaDeviasi += $deviasi; // Tambahkan nilai deviasi ke total
                  ?>
                    <td><?php echo $deviasi; ?></td>
                  <?php } ?>
                  <td><?php echo $totalSemuaDeviasi; ?></td> <!-- Tampilkan total deviasi di kolom terakhir -->
                </tr>
                </tfoot>
            </table>
          </div>
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <?php
                  foreach ($uniqueKriteria as $kriteria) {
                    // Hitung bobot kriteria berdasarkan nilai deviasi yang sudah dinormalisasi
        ...
        <div class="card">
          <div class="card-body">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <?php
                // Tampilkan nilai PSI untuk setiap alternatif
                foreach ($alternatif as $siswa) {
                  echo "<tr>";
                  echo "<td>" . $siswa['kode_siswa'] . "</td>";
                  ...
                  foreach ($nama_kriteria as $kriteria) {
                    ...
                    // Hitung nilai PSI untuk kriteria ini
                    $bobotKriteria = (1 - $totalNilai[$kriteria]) / $totalSemuaDeviasi;
