...
(function () {
    ...
    const getPreviewContent = (editor, html) => {
      ...
      if (html.indexOf('<html>') === -1) {
        ...
        previewHtml = '<!DOCTYPE html>' + '<html>' + '<head>' + '<base href="' + encode(editor.documentBaseURI.getURI()) + '">' + contentCssEntries + preventClicksOnLinksScript + '</head>
<!-- 
...
*/ -->' + '<body class="' + encode(bodyClass) + '"' + dirAttr + '>' + previewHtml + '</body>' + '</html>';
      }
